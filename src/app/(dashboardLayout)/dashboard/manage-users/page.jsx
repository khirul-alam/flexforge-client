...
export default function ManageUsersPage() {
  ...
  const handleBlock = async (id) => {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/users/block/${id}`, {
      method: 'PATCH',
      credentials: 'include',
    });
    const data = await res.json();
  ...
  const handleUnblock = async (id) => {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/users/unblock/${id}`, {
      method: 'PATCH',
      credentials: 'include',
    });
    const data = await res.json();
  ...
  const handleMakeAdmin = async (id) => {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/users/make-admin/${id}`, {
      method: 'PATCH',
      credentials: 'include',
    });
    const data = await res.json();
