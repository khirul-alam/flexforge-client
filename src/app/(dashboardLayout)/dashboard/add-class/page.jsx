  ...
  return (
    <div>
      ...
      <form
        ...
        className="grid max-w-2xl gap-4 rounded-lg bg-white p-6 shadow sm:grid-cols-2"
      >
        ...
        <button
          type="submit"
          disabled={submitting}
          className="col-span-full rounded-lg bg-orange-500 py-3 font-semibold text-white disabled:opacity-50"
        >
