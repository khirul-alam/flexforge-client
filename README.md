...
- Secure authentication using Better Auth (Credential + Google login) with JWT in-memory token for cross-domain support
...
- Admin controls: manage users (block/unblock/promote), manage trainers (demote), approve/reject classes, moderate forum posts, view transaction history
...
- Framer Motion animations on the homepage banner
