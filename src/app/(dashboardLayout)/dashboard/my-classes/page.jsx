...
export default function MyClassesPage() {
  ...
  return (
    <div>
                ...
                <td className="p-3">
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="rounded-lg bg-gray-500 px-3 py-1 text-xs text-white"
                    >
                      View Students
                    </button>
                    <button
      ...
      {viewingClassId && (
        <ViewStudentsModal classId={viewingClassId} onClose={() => setViewingClassId(null)} />
      )}
          ...
          <div className="w-full max-w-lg rounded-xl bg-white p-6">
            ...
            <form onSubmit={handleUpdateSubmit} className="grid gap-4 sm:grid-cols-2">
              ...
              <select
                ...
                defaultValue={editingClass.difficultyLevel}
                className="rounded-lg border p-3"
                required
              >
              ...
              <textarea
                ...
                className="col-span-full rounded-lg border p-3"
                rows={3}
                required
              />
              ...
              <div className="col-span-full flex justify-end gap-3">
                ...
                <button type="submit" className="rounded-lg bg-orange-500 px-4 py-2 text-white">
                  Save Changes
                </button>
              </div>
            </form>
