    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/50">
      <div className="w-full max-w-md rounded-xl bg-white p-6">
        ...
        <div className="mt-4 flex justify-end gap-3">
          ...
          <button onClick={handleReject} className="rounded-lg bg-red-500 px-4 py-2 text-white">Reject</button>
          <button onClick={handleApprove} className="rounded-lg bg-green-500 px-4 py-2 text-white">Approve</button>
        </div>
      </div>
    </div>
  );
